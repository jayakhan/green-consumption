...
ggplot(organic,aes(x=GC_cat, y=PM1, fill=GC_cat)) +
  ...
  labs(title="Green Consumption vs preference for newspaper",x="Green Consumption Levels",y="Newspaper") + 
...
ggplot(organic,aes(x=GC_cat, y=PM2, fill=GC_cat)) +
  geom_boxplot() +
  scale_fill_brewer(palette="Greens") +
  labs(title="Green Consumption vs preference for magazine",x="Green Consumption Levels",y="Magazine") + 
  theme_classic() + theme(legend.position="none")
...
ggplot(organic,aes(x=GC_cat, y=PM5, fill=GC_cat)) +
  geom_boxplot() +
  scale_fill_brewer(palette="Greens") +
  labs(x="Green Consumption Levels",y="Preference for Social Media") + 
  theme_classic() + theme(legend.position="none")
...
ggplot(organic,aes(x=GC_cat, y=TotalSI, fill=GC_cat)) +
  geom_boxplot() +
  scale_fill_brewer(palette="Greens") +
  labs(title="Green Consumption vs social influence",x="Green Consumption Levels",y="Social Influence") + 
  theme_classic() + theme(legend.position="none")
...
ggplot(organic,aes(x=GC_cat, y=TotalCNS, fill=GC_cat)) +
  geom_boxplot() +
  scale_fill_brewer(palette="Greens") +
  labs(x="Green Consumption Levels",y="Novelty Seeking Behavior") + 
  theme_classic() + theme(legend.position="none")
...
ggplot(organic,aes(x=PM1, y=TotalSI)) +
  geom_point() +
  geom_smooth(method="lm",col="red3") + theme_classic() +
  labs(title="Green Consumption vs Social Influence by Newspaper",x="Preference for Newspaper",y="Social Influence") +
  facet_wrap( ~ GC_cat) + 
  theme(plot.title = element_text(size=20, face="bold", hjust = 0.5)) +
  theme(axis.title.y = element_text(size = rel(1.5), angle = 90)) +
  theme(axis.title.x = element_text(size = rel(1.5), angle = 0))
...
ggplot(organic,aes(x=PM1, y=TotalCNS)) +
  geom_point() +
  geom_smooth(method="lm",col="red3") + theme_classic() +
  labs(x="Preference for Newspaper",y="Novelty Seeking Behavior") +
  facet_wrap( ~ GC_cat) + 
  theme(plot.title = element_text(size=20, face="bold", hjust = 0.5)) +
  theme(axis.title.y = element_text(size = rel(1.5), angle = 90)) +
  theme(axis.title.x = element_text(size = rel(1.5), angle = 0))
...
#include
ggplot(organic,aes(x=PM4, y=TotalSI)) +
  geom_point() +
  geom_smooth(method="lm",col="red3") + theme_classic() +
  labs(title="Green Consumption vs Preference for Radio by Social Influence", x="Preference for radio",y="Social Influence") +
  facet_wrap( ~ GC_cat) + 
  theme(plot.title = element_text(size=20, face="bold", hjust = 0.5)) +
  theme(axis.title.y = element_text(size = rel(1.5), angle = 90)) +
  theme(axis.title.x = element_text(size = rel(1.5), angle = 0))
...
ggplot(organic,aes(x=PM5, y=TotalCNS)) +
  geom_point() +
  geom_smooth(method="lm",col="red3") + theme_classic() +
  labs(title="Green Consumption vs Preference for Social Media by Novelty Seeking", x="Preference for social media",y="Novelty Seeking") +
  facet_wrap( ~ GC_cat) + 
  theme(plot.title = element_text(size=20, face="bold", hjust = 0.5)) +
  theme(axis.title.y = element_text(size = rel(1.5), angle = 90)) +
  theme(axis.title.x = element_text(size = rel(1.5), angle = 0))
...
ggplot(organic,aes(x=GC_cat, y=PM5, fill=GC_cat)) +
  ...
  theme_classic() + theme(legend.position="none") +
  facet_wrap( ~ Education) +
  labs(title="Green Consumption vs Social Media by Education",x="Green Consumption Levels",y="Preference for Social Media") +
  theme(plot.title = element_text(size=20, face="bold", hjust = 0.5)) +
  theme(axis.title.y = element_text(size = rel(1.5), angle = 90)) +
  theme(axis.title.x = element_text(size = rel(1.5), angle = 0))
...
ggplot(organic,aes(x=GC_cat, y=TotalSI, fill=GC_cat)) +
  ...
  theme_classic() + theme(legend.position="none") +
  facet_wrap( ~ Education) +
  labs(x="Green Consumption Levels",y="Social Influence") +
  theme(plot.title = element_text(size=20, face="bold", hjust = 0.5)) +
  theme(axis.title.y = element_text(size = rel(1.5), angle = 90)) +
  theme(axis.title.x = element_text(size = rel(1.5), angle = 0))
...
################Model development########################
model1 <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                 Ethnicity + No_household + Income + Occupation + Work_category +
                 TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
summary(model1)
coef(model1)
confint(model1)
exp(confint(model1))
...
model_noAge <- polr(GC_cat ~ Gender + Marital_status + Education +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noAge, test = "Chisq")


model_noGender <- polr(GC_cat ~ Age + Marital_status + Education +
                         Ethnicity + No_household + Income + Occupation + Work_category +
                         TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noGender, test = "Chisq")

model_noMs <- polr(GC_cat ~ Age + Gender + Education +
                     Ethnicity + No_household + Income + Occupation + Work_category +
                     TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noMs, test = "Chisq")

model_noEdu <- polr(GC_cat ~ Age + Gender + Marital_status +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noEdu, test = "Chisq")

model_noEthnicity <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                            No_household + Income + Occupation + Work_category +
                            TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noEthnicity, test = "Chisq")
#significant

model_noHouse <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                        Ethnicity + Income + Occupation + Work_category +
                        TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noHouse, test = "Chisq")
#Signifcant

model_noIncome <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                         Ethnicity + No_household + Occupation + Work_category +
                         TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noIncome, test = "Chisq")

model_noO <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                    Ethnicity + No_household + Income + Work_category +
                    TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noO, test = "Chisq")

model_noW <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                    Ethnicity + No_household + Income + Occupation +
                    TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noW, test = "Chisq")

model_noSI <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                     Ethnicity + No_household + Income + Occupation + Work_category +
                     TotalCNS + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noSI, test = "Chisq")
#significant

model_noCNS <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + PM1 + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noCNS, test = "Chisq")
#significant

model_noPM1 <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + TotalCNS + PM2 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noPM1, test = "Chisq")
#significant

model_noPM2 <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + TotalCNS + PM1 + PM3 + PM4 + PM5, data=organic)
anova(model1, model_noPM2, test = "Chisq")

model_noPM3 <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + TotalCNS + PM1 + PM2 + PM4 + PM5, data=organic)
anova(model1, model_noPM3, test = "Chisq")

model_noPM4 <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM5, data=organic)
anova(model1, model_noPM4, test = "Chisq")
#Significant

model_noPM5 <- polr(GC_cat ~ Age + Gender + Marital_status + Education +
                      Ethnicity + No_household + Income + Occupation + Work_category +
                      TotalSI + TotalCNS + PM1 + PM2 + PM3 + PM4, data=organic)
anova(model1, model_noPM5, test = "Chisq")
#significant

#Ethnicity, No_household, TotalSI, TotalCNS, PM1, PM4, PM5
###########################################################################

model_dev <- polr(formula = GC_cat ~ Age + Education + TotalCNS + TotalSI + No_household + 
                    Ethnicity + PM1 + PM4 + PM5, data = organic)

anova(model1, model_dev, test="Chisq")
#large p-value -> model_dev is better

confint(model_dev)


#try interactions
model_chiint <- polr(formula = GC_cat ~ Age + Education + TotalCNS + TotalSI + No_household + 
                       Ethnicity + PM1 + PM4 + PM5 + Age:Education + Age:TotalCNS + Age:TotalSI + Age:No_household +
                       Age:Ethnicity + Age:PM1 + Age:PM4 + Age:PM5 + Education:TotalCNS + Education:TotalSI +
                       Education:No_household + Education:Ethnicity + Education:PM1 + Education:PM4 + Education:PM5 +
                       TotalCNS:TotalSI + TotalCNS:No_household + TotalCNS:Ethnicity + TotalCNS:PM1 + TotalCNS:PM4 +
                       TotalCNS:PM5 + TotalSI:No_household + TotalSI:Ethnicity + TotalSI:PM1 + TotalSI:PM4 +
                       TotalSI:PM5 + No_household:Ethnicity + No_household:PM1 + No_household:PM4 + No_household:PM5 +
                       Ethnicity:PM1 + Ethnicity:PM4 + Ethnicity:PM5 + PM1:PM4 + PM1:PM5 + PM4:PM5, data = organic)
NullModel <- polr(GC_cat~1,data=organic) 
FullModel <- model_chiint
aic <- step(NullModel, scope = formula(FullModel),direction="both",trace=0) 
aic$call 

result1 <- polr(formula = GC_cat ~ Age + Education + TotalCNS + No_household + PM5 + PM4 + 
                  TotalSI + PM1 + Ethnicity + TotalSI:PM1 + PM4:TotalSI + TotalCNS:PM5, data = organic)

anova(model_dev, result1, test = "Chisq")
#less p-value -> result1 is better

#model_dev + int + eda_int
model_eda <- polr(formula = GC_cat ~ Age + Education + TotalCNS + TotalSI + No_household + 
                    Ethnicity + PM1 + PM4 + PM5 + Age:Education + Age:TotalCNS + Age:TotalSI + Age:No_household +
                    Age:Ethnicity + Age:PM1 + Age:PM4 + Age:PM5 + Education:TotalCNS + Education:TotalSI +
                    Education:No_household + Education:Ethnicity + Education:PM1 + Education:PM4 + Education:PM5 +
                    TotalCNS:TotalSI + TotalCNS:No_household + TotalCNS:Ethnicity + TotalCNS:PM1 + TotalCNS:PM4 +
                    TotalCNS:PM5 + TotalSI:No_household + TotalSI:Ethnicity + TotalSI:PM1 + TotalSI:PM4 +
                    TotalSI:PM5 + No_household:Ethnicity + No_household:PM1 + No_household:PM4 + No_household:PM5 +
                    Ethnicity:PM1 + Ethnicity:PM4 + Ethnicity:PM5 + PM1:PM4 + PM1:PM5 + PM4:PM5 + PM1:PM2 + 
...
result2 <- polr(formula = GC_cat ~ Age + Education + TotalCNS + No_household + PM5 + PM4 + 
                  TotalSI + PM1 + Ethnicity + TotalSI:PM1 + PM4:TotalSI + TotalCNS:PM5, data = organic)

anova(result1, result2, test = "Chisq")
#result1 is final model
#large p-value (1)
...
confint(final, level = 0.90)
exp(confint(final, level = 0.90))
confint(final, level = 0.95)
exp(confint(final, level = 0.95))
exp(coef(final))
...
table(organic$Age,organic$GC_cat)



p <- ggplot(organic, aes(x = Age, fill = GC_cat)) +
  geom_bar(position = "fill")
q <- p +
  aes(stringr::str_wrap(Age, 10)) + 
  labs(title = "Age vs Green Consumption") +
  xlab(NULL)
r <- q+
  scale_fill_discrete(name="Green consumption")
r


chisq.test(table(organic$Age, organic$GC_cat))
